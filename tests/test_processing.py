...
@pytest.mark.parametrize(
    "list_data, state, expected_count",
    [
...
def test_valid_filter_by_state(list_data: List[List[Dict[str, Any]]], state: str, expected_count: int) -> None:
...
@pytest.mark.parametrize(
    "invalid_data, state, expected_exception",
    [
...
@pytest.mark.parametrize(
    "invalid_operations, expected_exception",
    [
        # Нет ключа 'date'
